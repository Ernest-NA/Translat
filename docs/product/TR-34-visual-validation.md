...
- Browser preview disables persistence commands across the shell when the Tauri desktop bridge is unavailable, guards form submit paths, and shows a clear runtime message instead of raw `invoke` exceptions or error-state styling.
